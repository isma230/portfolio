            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 sm:gap-1 border-2 border-blue-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <p className=" text-[.9rem] text-justify break-words text-gray-500">
                  During my invigorating one-month internship at a dynamic tech
                  company, I delved into the heart of innovation and technology.
                  Immersed in a vibrant atmosphere, I had the privilege of being
                  with brilliant minds. The supportive mentorship I received
                  from seasoned professionals nurtured my growth, enabling me to
                  contribute meaningfully while absorbing invaluable insights.
                </p>
              </div>
            </div>
          </fieldset>
          ...
          >
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-blue-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                <h1 className="text-[1.4rem] font-semibold sm:text-xl">
                  Specialized Technician Diploma: Web Full Stack Developer
                </h1>
                <span className=" text-[.9rem] font-semibold text-gray-500 sm:text-base">
